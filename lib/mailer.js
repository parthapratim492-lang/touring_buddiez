...
tourbuddiez@gmail.com`;
  ...
  const html = `
    <div style="font-family:Arial,Helvetica,sans-serif;max-width:520px;margin:0 auto;color:#222A3D;">
      <div style="background:linear-gradient(135deg,#16294B,#1F3A66);padding:28px 24px;border-radius:12px 12px 0 0;">
        <h1 style="color:#F2C879;font-size:20px;margin:0;">Booking Confirmed 🎉</h1>
      </div>
      <div style="border:1px solid #E8ECF5;border-top:none;padding:24px;border-radius:0 0 12px 12px;">
        <p>Hi ${escapeHtml(booking.name || 'there')},</p>
        <p>Great news — your booking${pkgLine} with <b>Touring Buddiez</b> is now <span style="color:#1F3A66;font-weight:700;">CONFIRMED</span>.</p>
        ${dateLine}
        ${groupLine}
        ...
        <p style="margin-top:24px;font-size:13px;color:#56637C;">— Team Touring Buddiez<br>tourbuddiez@gmail.com &middot; +91 97073 86186</p>
      </div>
    </div>`;
